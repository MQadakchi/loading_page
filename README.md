...
- [x] A simple mini project to create **Page Loading Before The WebSite Is Fully Loaded**.
...
**Important Notice :** _In the `app.js` file in the `./js/app.js` directory, I use `loadingTime() + 2500` on line 16, because of local hosting and increase page load time. In real world you should remove `2500` from this code._
